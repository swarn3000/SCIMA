<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SCIMAMainPage.aspx.cs" Inherits="SCIMA.WebForm1" %>
...
<body>
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style3">
                    <img alt="SCIMA" class="auto-style27" src="images/SCIMA%20logo.jpg" /></td>
            </tr>
        </table>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style3">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="New prescription" CssClass="auto-style26" Font-Names="Arial" Font-Size="Medium" Width="440px" PostBackUrl="~/SCIMANewScript.aspx" />
                </td>
            </tr>
        </table>
        <table class="auto-style1">
